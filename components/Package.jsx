...
export default function Package() {
  ...
  return (
    <>
      <div className="mx-auto w-full h-full  lg:h-screen  flex  flex-col bg-gradient-to-tl rounded-3xl p-2 from-green-100 to-emerald-100 px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
